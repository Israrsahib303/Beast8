...
<div class="settings-wrapper">
    ...
    <div class="tabs">
        ...
        <button class="tab-btn" onclick="openTab('jarvis')">🤖 AI Jarvis</button>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div id="jarvis" class="s-card">
            <h4 style="margin-top:0; color:var(--primary);">🤖 Jarvis AI (Gemini) Settings</h4>
            <p style="color:#666; font-size:0.9rem; margin-bottom:20px;">
                Jarvis uses Google Gemini API to talk. Get a free key from <a href="https://aistudio.google.com/app/apikey" target="_blank">Google AI Studio</a>.
            </p>
            
            <div class="form-group">
                <label class="form-label">Google Gemini API Key</label>
                <input type="text" name="gemini_api_key" class="form-control" placeholder="AIzaSy..." value="<?= sanitize($GLOBALS['settings']['gemini_api_key'] ?? '') ?>">
            </div>
            
            <div class="form-group">
                <label class="form-label">Jarvis Personality</label>
                <textarea name="jarvis_personality" class="form-control" rows="3" placeholder="Instructions for AI..."><?= sanitize($GLOBALS['settings']['jarvis_personality'] ?? 'You are Jarvis, an assistant for Sir Israr. Speak in Hinglish. Be professional.') ?></textarea>
                <small style="color:#666;">Example: "You are Jarvis. Speak in Hinglish. Address me as Sir Israr."</small>
            </div>
        </div>
