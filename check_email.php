...
// --- PATH FIX: __DIR__ ka use karein taake rasta hamesha sahi rahe ---
$log_file = __DIR__ . '/../../assets/logs/email_payments.log';

// Ab directory change karein (includes folder mein jayen)
